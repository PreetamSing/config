...
local function generate_pallet_from_colorscheme()
  ...
  local color_map = {
    ...
    vibrant_blue = { index = 1000, default = "#03a9f4" },
    royal_blue   = { index = 1001, default = "#1273de" },
    grey         = { index = 1002, default = "#393939" },
  }
...
function M.generate_user_config_highlights()
  ...
  local sl_colors = {
    ...
    VibrantBlue = { fg = pal.royal_blue, bg = pal.black },
  }
  ...
  local groups = {
    ...
    EdenSLAlt = { fg = pal.white, bg = pal.grey },
    EdenSLAltSep = { fg = pal.sl.bg, bg = pal.grey },
    EdenSLModeSep ={ fg = pal.royal_blue, bg = pal.black },
    EdenSLGitBranch = { fg = pal.vibrant_blue, bg = pal.sl.bg },
